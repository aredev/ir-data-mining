...
class GraphCluster:
    ...
    def plot_graph(self, filename, labels="black", outlier_label=-1):
        ...
        nx.draw_networkx_nodes(self.graph, pos, width=15, node_color=labels, node_size=2, alpha=1)
        nx.draw_networkx_edges(self.graph, pos, width=1, edge_color='r', alpha=1)
